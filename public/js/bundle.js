...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(username, email, password, passwordConfirm) {
    var res;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 8:
          ...
          (0, _alerts.showAlert)("error", "error when logout try again");
        case 11:
        case "end":
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"taskHandlers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.doTask = exports.deleteTask = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var doTask = exports.doTask = /*#__PURE__*/function () {
...
exports.addTask = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(task) {
    var newTask, res, _newTask, markup, tasksContainer, _task;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          newTask = _objectSpread({}, task);
          _context3.prev = 1;
          _context3.next = 4;
          return (0, _axios.default)({
            method: "POST",
        ...
        case 4:
          res = _context3.sent;
          if (res.data.status === "success") {
            _newTask = res.data.data;
            markup = "\n      <div data-taskid=\"".concat(_newTask.id, "\">\n        <input type=\"checkbox\">\n        <p>\n          <span>").concat(_newTask.name, "</span>\n          \n          <span>").concat("".concat(_newTask.dueDate).slice(0, 25), "</span>\n        </p>\n        <button id=\"remove\">x</button></div>\n      ");
            tasksContainer = document.querySelector(".tasks");
            tasksContainer.insertAdjacentHTML("beforeend", markup);
            _task = tasksContainer.lastElementChild;
            _task.firstElementChild.addEventListener("change", function (e) {
              doTask(_task.dataset.taskid);
            });
            _task.lastElementChild.addEventListener("click", function (e) {
              deleteTask(_task.dataset.taskid);
              _task.parentElement.removeChild(_task);
            });
          }
          _context3.next = 12;
          break;
...
var _taskHandlers = require("./taskHandlers");
...
tasks.forEach(function (task) {
  task.firstChild.addEventListener("change", function (e) {
    (0, _taskHandlers.doTask)(task.dataset.taskid);
  });
  task.lastElementChild.addEventListener("click", function (e) {
    (0, _taskHandlers.deleteTask)(task.dataset.taskid);
